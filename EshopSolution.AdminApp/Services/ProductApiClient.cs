...
namespace EshopSolution.AdminApp.Services
{
    public class ProductApiClient : BaseApiClient, IProductApiClient
    {
        ...
        public async Task<bool> CreateProduct(ProductCreateRequest request)
        {
            ...
            //var httpcContent = new StringContent(json, Encoding.UTF8, "application/json");
        ...
        public async Task<ApiResult<ProductUpdateRequest>> GetPoductUpdateById(int productId)
        {
            var languageId = _httpContextAccessor.HttpContext.Session.GetString(SystemConstants.AppSettings.DefaultLanguageId);
            var client = _httpClientFactory.CreateClient();
            client.BaseAddress = new Uri(_configuration[SystemConstants.AppSettings.BaseAddress]);
            ...
            if (response.IsSuccessStatusCode)
                return JsonConvert.DeserializeObject<ApiSuccessResult<ProductUpdateRequest>>(body);

            return JsonConvert.DeserializeObject<ApiErrorResult<ProductUpdateRequest>>(body);
        }
