    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                ...
                new CategoryTranslation() { Id=3, CategoryId=2,Name = "Ao Nu", LanguageId = "vi-VN", SeoAlias = "ao-nu", SeoDescription = "San pham ao thoi trang nu", SeoTitle = "San pham ao thoi trang nu" },
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "Tan@123"),
